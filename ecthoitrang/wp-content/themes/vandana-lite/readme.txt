...
Vandana local fonts feature is based on Webfonts Loader by WordPress Themes Team (WPTT). (https://github.com/WPTT/webfont-loader)
License: MIT
...
== Changelog ==
    ...
    1.1.8 - July 24, 2023
        * Update: Google Fonts Library has been updated.
        * Update: Relevant tags for the themes have been added.

    1.1.7 - June 13, 2023
        * New Feature: Added integration of Coach Podium to integrate Wheel of Life assessment.
        * Fix: Elementor list icon color issue is fixed.
        * Fix: Fixed sidebar issue in 404 page.
        * Update: Updated google fonts.

    1.1.6 - August 19, 2022
        * Fix: Fixed Elementor deprecated warning.
        * Fix: TGMPA plugin installation warning issue for php 8.
